...
export _HEALTHCHECK_SLEEP_SECONDS=5
...
healthcheck "Proxy" http://localhost:5000/_status || exit 1
...
while true; do
    ...
    healthcheck "Proxy" http://localhost:5000/_status $_STATUSCHECK_ATTEMPTS || exit 1
