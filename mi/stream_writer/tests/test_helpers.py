...
from mi.stream_writer.psycopg2 import errorcodes
...
def test_insert_mi_record_with_not_null_contraint(
    ...
    error = _IntegrityError(pgcode=errorcodes.NOT_NULL_VIOLATION)
...
def test_insert_mi_record_with_any_other_pg_error(
    ...
    error = _IntegrityError(pgcode=errorcodes.DATA_CORRUPTED)
