...
from nrlf.core.decorators import deprecated, error_handler
...
#     event = create_test_api_gateway_event(query_string_parameters=None)
#     context = create_mock_context()
...
#     event = create_test_api_gateway_event(body=json.dumps({"param1": "test", "param2": 123}))
#     context = create_mock_context()
...
#     event = create_test_api_gateway_event(body=None)
#     context = create_mock_context()
