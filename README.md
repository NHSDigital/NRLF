...
eg nrlf report ref - runs the report pack on Ref with end date of today and start date 7 days previous
   nrlf report ref --start_date=2023-09-15 --end_date=2023-09-17 - runs the report pack on Ref between the 2 dates specified
```
...
All reports, test or otherwise, are saved to `mi/reporting/report`. The reports that have optional start_date and end_date parameters are NRL-210 and NRL-218.
