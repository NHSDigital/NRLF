...
from api.producer.updateDocumentReference.src.config import (
    Config,
    build_persistent_dependencies,
)
from api.producer.updateDocumentReference.src.v1.handler import steps as v1_steps
from api.producer.updateDocumentReference.src.v2.handler import steps as v2_steps
from api.producer.updateDocumentReference.src.versioning import get_version_from_header
