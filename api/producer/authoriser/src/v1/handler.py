...
from nrlf.core.model import AuthProducer
...
@log_action(narrative="Authenticate producer request")
def authenticate_request(
    ...
    try:
        authentication_results: AuthProducer = repository.read(**authentication_query)
    except ItemNotFound:
...
@log_action(narrative="Authorise producer request")
...
steps = [parse_headers, authenticate_request, authorise_request, authorise]
