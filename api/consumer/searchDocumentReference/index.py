...
from api.consumer.searchDocumentReference.src.v1.handler import steps as v1_steps
from api.consumer.searchDocumentReference.src.v2.handler import steps as v2_steps
from api.consumer.searchDocumentReference.src.versioning import get_version_from_header
