...
from api.consumer.searchViaPostDocumentReference.src.config import (
    Config,
    build_persistent_dependencies,
)
from api.consumer.searchViaPostDocumentReference.src.v1.handler import steps as v1_steps
from api.consumer.searchViaPostDocumentReference.src.v2.handler import steps as v2_steps
from api.consumer.searchViaPostDocumentReference.src.versioning import (
