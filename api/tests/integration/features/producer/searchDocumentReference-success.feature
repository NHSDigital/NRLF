Feature: Consumer - searchDocumentReference - Success Scenarios
  ...
  Scenario: Search for multiple DocumentReferences by NHS number
    ...
    And a DocumentReference resource exists with values:
      | property    | value                                   |
      | id          | 8FW23-1114567890-SearchMultipleRefTest1 |
      | subject     | 9278693472                              |
      | status      | current                                 |
      | type        | 736253002                               |
      | contentType | application/pdf                         |
    ...
    And a DocumentReference resource exists with values:
      | property    | value                                   |
      | id          | 8FW23-1114567890-SearchMultipleRefTest2 |
      | subject     | 9278693472                              |
      | status      | current                                 |
      | type        | 736253002                               |
      | contentType | application/pdf                         |
    ...
    And a DocumentReference resource exists with values:
      | property    | value                                   |
      | id          | 8FW23-1114567890-SearchMultipleRefTest3 |
      | subject     | 9278693472                              |
      | status      | current                                 |
    ...
    And the Bundle contains an DocumentReference entry with values
      | property    | value                                   |
      | id          | 8FW23-9999999999-SearchMultipleRefTest1 |
      | subject     | 9999999999                              |
      | status      | current                                 |
      | type        | 736253002                               |
      | contentType | application/pdf                         |
    ...
    And the Bundle contains an DocumentReference entry with values
      | property    | value                                   |
      | id          | 8FW23-9999999999-SearchMultipleRefTest2 |
      | subject     | 9278693472                              |
      | status      | current                                 |
      | type        | 736253002                               |
      | contentType | application/pdf                         |
      | url         | https://example.org/my-doc-2.pdf        |
      | custodian   | 8FW23                                   |
    And the Bundle does not contain a DocumentReference with ID '8FW23-9999999999-SearchMultipleRefTest3'
  ...
  Scenario: Search for multiple DocumentReferences by NHS number - S3 authorisation
    ...
    And a DocumentReference resource exists with values:
      | property    | value                                   |
      | id          | 8FW23-9999999999-SearchMultipleRefTest3 |
      | subject     | 9999999999                              |
      | status      | current                                 |
      | type        | 887701000000100                         |
      | contentType | application/pdf                         |
