Feature: Producer NRL-to-R4 Conversion Failures
  ...
  Scenario Outline: Cannot convert NRL to R4 because data contract has been broken
    ...
    Examples:
      ...
      | https://directory.spineservices.nhs.uk/STU3/Organization/8FW23 |               |                 | 341ec927-22f2-11ed-bd8d-000c290de2c0-58504e523530384b5851 | current    | 718377777 | 2021-03-08T15:26:00+01:00     | ValidationError | 'InvalidValue' encountered on 'DocumentPointer.lastModified': Could not parse datetime from '2021-03-08T15:26:00+01:00'.                               |
