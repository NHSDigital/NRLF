Feature: Basic Success Scenarios where consumer is able to search for Document Pointers using POST
  ...
  Scenario: Successfully search for multiple Document Pointers by NHS number no limit
    Given a Document Pointer exists in the system with the below values
      | property    | value                          |
      | identifier  | 1114567890                     |
      | type        | 736253002                      |
    ...
    And a Document Pointer exists in the system with the below values
      ...
      | type        | 736253002                        |
      | custodian   | ANOTHER DIFFERENT CUSTODIAN      |
      | subject     | 9278693472                       |
      | contentType | application/pdf                  |
  ...
  Scenario: Successfully search for multiple Document Pointers by NHS number limit by 2 items and access page 1
    ...
    And a Document Pointer exists in the system with the below values
      ...
      | identifier  | 4444567890                       |
      | type        | 736253002                        |
      | custodian   | A DIFFERENT CUSTODIAN 2          |
      | subject     | 9278693472                       |
      | contentType | application/pdf                  |
      | url         | https://example.org/my-doc-3.pdf |
    And Consumer "TEST CONSUMER" has permission to search Document Pointers for
  ...
  Scenario: Successfully search for multiple Document Pointers by NHS number limit to 4 items but on page 3
    ...
    And a Document Pointer exists in the system with the below values
      | property    | value                            |
      | identifier  | 5555567890                       |
      | type        | 736253002                        |
      | custodian   | ANOTHER DIFFERENT CUSTODIAN 2    |
      | subject     | 9278693472                       |
      | contentType | application/pdf                  |
      | url         | https://example.org/my-doc-3.pdf |
    And Consumer "TEST CONSUMER" has permission to search Document Pointers for
